...
echo "echo \"当前设置: $CPOLAR $MENUCONFIG_COLOR $CPOLAR_TOKEN_TYPE wujinjun|others|larger|busybox:${USE_WUJINJUN}|${USE_OTHERS}|${USE_LARGER}|${USE_BUSYBOX} single_thread:$FORCE_SINGLE_THREAD ccache:$USE_CCACHE sccache:$USE_SCCACHE\"" >> ~/.bash_profile
